...
# TODO: delete the unused root parameter from BaseDecisionTree for cleaner scaffolded code. (v0.3.2)
# TODO: move data validating and cleaning to a separarte class from DecisionTreeWriter and add better validating and cleaning methods (v0.3.3)
...
# TODO: Add support for regression trees as well, and perhaps tries and n-ary trees instead of just binary trees
